...
public interface CommonService {
    ...
    @GET("/api/v1/activation_code/activation")
    Observable<LoginResult> login(@Query("act_code") String code_no);
    ...
    Observable<HttpResult> modifyPhone(@Query("destPackageInfos") String destPackageInfos, @Query("sdkVersion") String sdkVersion ,@Query("sdkInt") String sdkInt);
